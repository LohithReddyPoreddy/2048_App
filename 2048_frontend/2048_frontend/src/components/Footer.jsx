...
function Footer() {
  ...
  <div class="container mx-auto flex justify-between items-center">
    ...
    <div class="flex items-center gap-4">
      <a href="https://www.linkedin.com" target="_blank" class="hover:text-blue-500 transition-colors duration-200">
      ...
      <a href="https://github.com" target="_blank" class="hover:text-gray-400 transition-colors duration-200">
        <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="currentColor" viewBox="0 0 24 24">
